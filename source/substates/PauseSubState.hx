...
class PauseSubState extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		//pauseMusic.volume = 0;
		//, FlxG.random.int(0, Std.int(pauseMusic.length / 2))
		...
		chartingText.setFormat(Paths.font(mainFont), 32);
	...
	function regenMenu():Void {
		...
		for (num => str in menuItems) {
			...
			if(str == 'Skip Time')
			{
				...
				skipTimeText.setFormat(Paths.font(mainFont), 64, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
